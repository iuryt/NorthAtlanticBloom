# -*- coding: utf-8 -*-
#
# NorthAtlanticBloom documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'NorthAtlanticBloomdoc'
...
latex_documents = [
    ('index',
     'NorthAtlanticBloom.tex',
     u'NorthAtlanticBloom Documentation',
     u"iury simoes-sousa[D[D[D[D[D[D[D[D[D[D[D[D[D T.[2~ simoesd-sousa", 'manual'),
]
